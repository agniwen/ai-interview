  ...
  return (
    ...
    >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-1.5 py-2">
        {/* oxlint-disable-next-line no-nested-ternary -- Sidebar branches collapse/empty/list; flattening into a helper adds indirection. */}
        {showExpandedSidebar ? (
          displayConversations.length === 0 ? (
            <p className="px-2 py-3 text-muted-foreground text-xs">暂无本地聊天记录</p>
          ) : (
        ...
        ) : /* oxlint-disable-next-line no-nested-ternary -- Collapsed sidebar branches on presence of conversations. */
        displayConversations.length > 0 ? (
          <TooltipProvider>
                      ...
                      <TooltipTrigger asChild>
                        ...
                        >
                          <div
                            className={cn(
                              "h-1.5 rounded-full",
                              isActive ? "bg-foreground/40 w-full" : "bg-muted-foreground/12 w-3/4",
                            )}
                          />
                        </Link>
                      </TooltipTrigger>
