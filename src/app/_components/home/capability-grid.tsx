...
const capabilities: Capability[] = [
  {
    ...
    surfaceClass:
      "bg-gradient-to-br from-violet-50/80 to-fuchsia-50/30 dark:from-violet-500/8 dark:to-fuchsia-500/4",
    title: "聊天式筛选",
  },
  {
    ...
    surfaceClass:
      "bg-gradient-to-br from-amber-50/80 to-orange-50/30 dark:from-amber-500/8 dark:to-orange-500/4",
    title: "工作台配置",
  },
  {
    Icon: RadioIcon,
    ...
    surfaceClass:
      "bg-gradient-to-br from-rose-50/80 to-pink-50/30 dark:from-rose-500/8 dark:to-pink-500/4",
    title: "实时语音面试",
  },
  {
    Icon: SparklesIcon,
    ...
    surfaceClass:
      "bg-gradient-to-br from-sky-50/80 to-cyan-50/30 dark:from-sky-500/8 dark:to-cyan-500/4",
    title: "智能追问",
  },
  {
    Icon: GaugeIcon,
    ...
    surfaceClass:
      "bg-gradient-to-br from-emerald-50/80 to-teal-50/30 dark:from-emerald-500/8 dark:to-teal-500/4",
    title: "结构化评估",
  },
  {
    ...
    surfaceClass:
      "bg-gradient-to-br from-slate-50/80 to-zinc-50/30 dark:from-slate-500/8 dark:to-zinc-500/4",
    title: "数据可控",
  },
];
      ...
      <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3">
        {capabilities.map(({ Icon, description, iconClass, surfaceClass, title }, index) => (
          <FadeContent delay={0.05 * index} key={title}>
            <article
              className={`group relative h-full overflow-hidden rounded-2xl border border-primary/10 p-6 ring-1 ring-primary/5 backdrop-blur transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_44px_-26px_rgba(0,0,0,0.4)] ${surfaceClass}`}
            >
              <div
