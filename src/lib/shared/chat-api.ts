 ...
 *
 * 新代码请直接 `import { fetchConversations } from "@/lib/client/api"`，
 * 本文件仅为渐进迁移而保留，未来可在所有调用站点更新后删除。
 *
 * New code should `import { fetchConversations } from "@/lib/client/api"` directly.
...
} from "@/lib/client/api/endpoints/chat";
