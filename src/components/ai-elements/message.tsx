  ...
  return (
    <div
      className={cn(
        ...
        'group-[.is-user]:ml-auto group-[.is-user]:bg-background group-[.is-user]:max-w-[88%] group-[.is-user]:rounded-lg group-[.is-user]:border group-[.is-user]:border-border/70  group-[.is-user]:px-3 group-[.is-user]:py-2 group-[.is-user]:text-foreground',
...
export function MessageBranchSelector({
  ...
  return (
    <ButtonGroup
      className={cn(
        '[&>*:not(:first-child)]:rounded-l-sm [&>*:not(:last-child)]:rounded-r-sm',
        className,
      )}
