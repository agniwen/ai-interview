...
export const agentTrackToggleVariants = cva(["size-9"], {
  ...
  variants: {
    ...
    variant: {
      default: [
        "data-[state=off]:bg-danger/10 data-[state=off]:text-danger",
        "data-[state=off]:hover:bg-danger/15",
        "data-[state=off]:focus-visible:ring-danger/30",
        "data-[state=on]:bg-default data-[state=on]:text-default-foreground",
        "data-[state=on]:hover:bg-foreground/10",
      ],
      outline: [
        "data-[state=off]:bg-danger/10 data-[state=off]:text-danger data-[state=off]:border-danger/20",
        "data-[state=off]:hover:bg-danger/15 data-[state=off]:hover:text-danger",
        "data-[state=off]:focus:text-danger",
        "data-[state=off]:focus-visible:border-danger data-[state=off]:focus-visible:ring-danger/30",
