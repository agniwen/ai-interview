...
function processUniform<T extends UniformType>(gl: WebGLRenderingContext, location: WebGLUniformLocation, t: T, value: number | number[]) {
...
interface Uniform { type: string, value: number[] | number }
