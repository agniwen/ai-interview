...
function CalendarRoot({ className, rootRef, ...props }: { className?: string, rootRef?: React.Ref<HTMLDivElement> } & React.ComponentProps<'div'>) {
  return (
    <div
      data-slot='calendar'
      ref={rootRef}
...
function CalendarChevron({ className, orientation, ...props }: { className?: string, orientation?: string } & React.ComponentProps<'svg'>) {
  if (orientation === 'left') {
    return (
