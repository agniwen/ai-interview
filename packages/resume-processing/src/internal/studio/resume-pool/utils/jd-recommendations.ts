...
import { getResumeSemanticIndexConfig } from "../../../lib/resume-semantic/indexer";
import {
  SEARCH_LIMIT_BY_CHUNK,
  mergeVectorScores,
  weightedScore,
} from "../../../../semantic/resume/scoring";
import type { VectorScores } from "../../../../semantic/resume/scoring";
import { buildResumeSemanticTexts } from "../../../../semantic/resume/text-builders";
import type {
