...
// OAuth/JWT tables generated with auth@1.7.2; keep aligned with the official provider schema.
...
// Each external OAuth grant is bound to one immutable workspace selection.
