...
import { buildSenderFromAddress, getResendClient } from "@arc/backend/lib/server/resend";
import {
  FEISHU_PROVIDER_IDS,
  postFeishuDirectCard,
} from "@arc/backend/server/routes/feishu/utils/bot";
import type { FeishuProviderId } from "@arc/backend/server/routes/feishu/utils/bot";
import {
  InterviewSummaryCard,
  resolveHeaderTemplate,
} from "@arc/backend/server/routes/feishu/utils/interview-summary-card";
import { getGlobalConfig } from "@arc/backend/server/routes/studio/routes/global-config/dao";
import { renderInterviewSummaryEmail } from "@arc/backend/server/routes/studio/routes/interviews/routes/round-emails/utils/templates";
