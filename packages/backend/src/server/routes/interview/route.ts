...
import { buildRecordingFileKey, isRecordingStorageConfigured } from "@arc/backend/lib/server/s3";
import {
...
import { authMiddleware } from "@arc/backend/server/middlewares/auth";
...
import { loadApplicableCandidateFormTemplates } from "@arc/backend/server/routes/studio/routes/forms/dao/queries";
import { loadSubmittedTemplateIds } from "@arc/backend/server/routes/studio/routes/forms/dao/submissions";
import {
  loadCandidateFormTemplateVersionById,
  resolveOrCreateTemplateVersion,
} from "@arc/backend/server/routes/studio/routes/forms/dao/versions";
import {
  cacheTags,
