...
vi.mock("@arc/backend/server/agents/resume-parser-agent", () => ({
...
vi.mock("@arc/backend/lib/server/db", () => ({ db: {} }));
...
vi.mock("@arc/backend/server/routes/studio/routes/interview-questions/dao", () => ({
...
import { storeInterviewResume } from "@arc/backend/server/routes/interview/utils";
