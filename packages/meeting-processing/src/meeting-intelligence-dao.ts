...
export interface RequestMeetingIntelligenceRunInput {
  actorId: string | null;
  meetingId: string;
  model: string;
...
export function createMeetingIntelligenceDao(db: Database) {
  ...
  async function requestMeetingIntelligenceRun(
    input: RequestMeetingIntelligenceRunInput,
  ...
  async function claimMeetingIntelligenceRun(input: {
    attempt: number;
  ...
  async function loadMeetingIntelligenceTranscript(input: {
    meetingId: string;
    organizationId: string;
    transcriptRevisionId: string;
  }) {
  ...
  async function saveMeetingIntelligenceProgress(input: {
    executionToken: string;
    processingRunId: string;
  ...
  async function heartbeatMeetingIntelligenceRun(input: {
    executionToken: string;
    processingRunId: string;
  }): Promise<boolean> {
    const [updated] = await db
  ...
  async function publishMeetingIntelligence(input: {
    executionToken: string;
    processingRunId: string;
  }): Promise<boolean> {
    const candidate = await db.query.meetingProcessingRun.findFirst({
  ...
  async function markMeetingIntelligenceFailed(input: {
    errorMessage: string;
    executionToken: string;
    processingRunId: string;
    terminal: boolean;
  ...
  async function loadMeetingIntelligenceResult(input: {
    meetingId: string;
    organizationId: string;
  ...
  async function listRecoverableMeetingIntelligenceJobs(): Promise<MeetingIntelligenceJobData[]> {
  ...
  async function listMeetingsNeedingAutomaticIntelligence(): Promise<
