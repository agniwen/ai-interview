...
本节优先于下文历史发送口径。候选人面试邮件必须由 HRD 知晓收件人和内容后主动发送；现阶段人工发送体验未完成验收，先全部暂停，待各流程页面重新设计后恢复。

- 移除独立发送候选人邀请按钮及各操作中的邮件选择弹窗，正常推进、发起、排期、改期、取消保持可用。
- 候选人的邀请、回执、改期、取消、异常邮件和定时邮件提醒均暂停，包括此前已确认但尚未发送的队列任务。
- 保留当前有效面试链接复制，由 HRD 人工联系候选人。内部 HR、面试官飞书通知及工作区成员邀请不受影响。
- 不删除历史记录、不做数据库迁移；以后恢复发送必须明确重新设计和验收，不自动重放本次被阻断任务。

> 文档状态：已确认；Phase 1 核心闭环已实现，Phase 2/3 待继续
>
> 日期：2026-08-18（2026-08-26 按已跑通流程收口）
>
> 适用产品：AI Hiring Copilot
>
