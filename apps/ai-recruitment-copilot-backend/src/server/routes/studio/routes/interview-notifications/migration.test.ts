...
const migration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260820123000_interview_notification_foundation/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
const roundlessNotificationMigration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260824090000_interview_notification_roundless_copy/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
const aiHrInitialCopyMigration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260824093000_ai_hr_initial_notification_copy/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
const aiInvitationExceptionMigration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260825030000_ai_invitation_exception_notifications/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
const aiInvitationExceptionCandidateEmailMigration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260825040000_ai_invitation_exception_candidate_email/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
const humanDirectConfirmationMigration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260825050000_human_interview_direct_confirmation_notifications/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
const humanConfirmationRecipientCleanupMigration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260825051000_human_interview_confirmation_recipient_cleanup/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
const humanExternalNotificationCopyMigration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260826143000_human_interview_external_notification_copy/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
const humanProgressionInvitationCopyMigration = readFileSync(
  new URL(
    "../../../../../../../ai-recruitment-copilot/drizzle/20260826152000_human_interview_progression_invitation_copy/migration.sql",
    import.meta.url,
  ),
  "utf-8",
);
