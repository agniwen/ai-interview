    ...
    <>
      {destinations.map((destination) => (
        ...
        >
          ...
          <Icon icon="ph:arrow-elbow-down-right" aria-hidden="true" />
  ...
  return (
    ...
    <>
      <DropdownMenuItem disabled={locked} onClick={() => actions.duplicateNode(ruleId)}>
        <Icon icon="ph:copy" aria-hidden="true" />
      ...
      {actions.convertToAdvanced && actions.variant !== "advanced" ? (
        <DropdownMenuItem onClick={() => actions.convertToAdvanced?.()}>
          ...
          <Icon icon="ph:sliders-horizontal" aria-hidden="true" />
  ...
  return (
    ...
    >
      ...
      <ButtonGroupText
        ...
        className="bg-background dark:bg-input/30 cursor-default gap-1.5 shrink-0"
      >
        {field.icon}
      ...
      <FilterOperatorPopover
        ...
        trigger={
          <ButtonGroupText
            ...
            className={cn(
              "hover:bg-accent bg-background dark:bg-input/30 cursor-default shrink-0",
        ...
        <FilterValuePopover
          ...
          trigger={
            <ButtonGroupText
              ...
              className={cn(
                "hover:bg-accent bg-background dark:bg-input/30 cursor-default min-w-0 overflow-hidden",
