      ...
      <>
        ...
        */}
        ...
        {itemState.selected ? (
          ...
          >
            <Icon icon="ph:check" className="text-foreground! **:text-foreground!" />
          </span>
        ) : null}
      </>
    ),
    ...
    <Cascader {...cascaderProps}>
      <CascaderPanel>
        ...
        */}
        ...
        {/* Static member/job options can exceed a page. Keep the upstream
            non-virtual path only for pinned rows, whose highlight keeper needs it. */}
        <CascaderList
          /**
        ...
        >
          {pinSelected ? <CascaderItems /> : <CascaderVirtualItems />}
        </CascaderList>
        <CascaderFooter />
        <CascaderStatus />
        {/*
