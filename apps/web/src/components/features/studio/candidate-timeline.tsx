...
const ACTIVITY_FORMATTERS = createActivityFormatters({
  "AI 报告同步": () => "同步 AI初面报告",
  "AI 通话开始": () => "开始 AI 通话",
  "AI 面试中断": formatWithRound("中断 AI初面"),
  "AI 面试已排期": formatWithRound("排期 AI初面"),
  "AI 面试开始": formatWithRound("开始 AI初面"),
  "AI 面试结束": formatWithRound("完成 AI初面"),
  "Offer 已发送": () => "发送 Offer",
  "Offer 已撤回": () => "撤回 Offer",
  上下文已刷新: () => "刷新 AI初面上下文",
  ...
  "创建 Offer": () => "创建 Offer",
  创建AI面试轮次: formatWithRound("创建AI初面轮次"),
  创建真人复面: formatWithRound("创建真人面试"),
  "发起 AI 面试": formatWithDescription("发起 AI初面", "发起 AI初面"),
  报告通知发送失败: () => "发送报告通知失败",
  报告通知已发送: () => "发送报告通知",
  报告通知待发送: () => "等待发送报告通知",
  "更新 Offer": formatWithDescription("更新 Offer", "更新 Offer"),
  更新真人复面: formatWithDescription("更新真人面试", "更新真人面试"),
  真人复面取消: formatWithRound("取消真人面试"),
  真人复面完成: formatWithRound("完成真人面试"),
  真人复面已排期: formatWithRound("安排真人面试"),
...
function TimelineEventItem({ event }: { event: CandidateTimelineEvent }) {
  ...
  const hasPreview = Boolean(event.description || event.metadata.length > 0);
