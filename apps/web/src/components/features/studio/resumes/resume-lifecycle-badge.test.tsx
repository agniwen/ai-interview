...
describe("ResumeLifecycleBadge", () => {
  it("uses a fixed indigo palette for informational lifecycle stages", () => {
    ...
    expect(markup).toContain("border-indigo-500/30");
    expect(markup).toContain("bg-indigo-500/10");
    expect(markup).toContain("text-indigo-700");
    expect(markup).toContain("hover:ring-indigo-500/10");
