...
describe("resume dedup comparison model", () => {
  ...
  it("uses the converted PDF endpoint for PPTX while preserving the original download", () => {
    expect(
      ...
      downloadUrl:
        "http://localhost:8787/workspaces/acme/candidates/resumes/resume-2/review/resume",
      kind: "pdf",
      previewUrl:
        "http://localhost:8787/workspaces/acme/candidates/resumes/resume-2/review/resume-preview.pdf",
    });
  });
