...
export function Card({
  ...
  const defaultProps = {
    className: cn(
      "relative flex flex-col rounded-2xl border border-input bg-card text-card-foreground",
      className,
    ),
    "data-slot": "card",
  };
