...
function DataGridProvider<TData extends object>({
  ...
  // Row selection follows the same rule: checkboxes and row highlighting
  // subscribe to `table.atoms.rowSelection`, so changing one checkbox must
  // not invalidate every context consumer and re-render every business cell.
  const value = useMemo(
    () => ({
      get props() {
