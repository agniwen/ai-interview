...
import type { WorkspaceAccessPolicyDependencies } from "../workspace-access-policy";

const mocks = {
  computeWorkspacePermissionSnapshot:
    vi.fn<WorkspaceAccessPolicyDependencies["computeWorkspacePermissionSnapshot"]>(),
};

const dependencies: WorkspaceAccessPolicyDependencies = mocks;
