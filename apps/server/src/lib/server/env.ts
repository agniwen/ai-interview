...
export const SERVER_ENV_NAMES = [
  ...
  "HUMAN_INTERVIEW_DOCUMENT_SYNC_ENABLED",
  "HUMAN_INTERVIEW_TRANSCRIPTION_MODE",
  "HUMAN_INTERVIEW_TRANSCRIPTION_ORGANIZATIONS",
  "HUMAN_TRANSCRIPTION_MAX_MEETINGS",
...
const serverEnvSchema = {
  ...
  HUMAN_INTERVIEW_DOCUMENT_SYNC_ENABLED: z.enum(["true", "false"]).default("true"),
  HUMAN_INTERVIEW_TRANSCRIPTION_MODE: z
    .enum(["legacy", "shadow", "server_realtime"])
    .default("legacy"),
  HUMAN_INTERVIEW_TRANSCRIPTION_ORGANIZATIONS: z.string().optional(),
  HUMAN_TRANSCRIPTION_MAX_MEETINGS: z
    .string()
    .regex(/^[1-9]\d{0,3}$/)
    .default("8"),
