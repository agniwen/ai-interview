...
function PathChevron() {
  return <Icon icon="ph:caret-right" className="size-3 shrink-0 opacity-50 rtl:-scale-x-100" />;
}
...
function CascaderBack({ className, children, ...props }: CascaderBackProps) {
  ...
  const defaultProps = {
    ...
    children: children ?? <Icon icon="ph:caret-left" className="size-4 rtl:-scale-x-100" />,
  };
