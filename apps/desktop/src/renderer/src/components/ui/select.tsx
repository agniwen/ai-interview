      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            ...
            "t-dropdown relative isolate z-[350] max-h-(--available-height) min-w-[8rem] touch-pan-y overflow-x-hidden overflow-y-auto data-[align-trigger=true]:w-(--anchor-width) data-[align-trigger=true]:transition-none",
            className,
          )}
