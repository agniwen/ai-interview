...
import { z } from "zod";
import { identifierSchema, successResponseSchema } from "../../candidate-api/shared.schemas.js";
import { CANDIDATE_INTERVIEW_PORT } from "./interview.port.js";
...
export class InterviewController {
  constructor(
    ...
    private readonly interviews: CandidateInterviewPort,
  ) {}
