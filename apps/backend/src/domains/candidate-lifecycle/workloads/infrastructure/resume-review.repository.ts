/* oxlint-disable complexity, require-await, anti-slop/no-unknown-parameters, anti-slop/no-unknown-returns, anti-slop/no-runtime-typeof -- Review generation, immutable JD snapshots, and guarded publication are one durable workflow. */
...
import type { JobEvaluationSnapshot, JobEvaluationSnapshotCommands } from "../../../jobs/public.js";
...
export class ResumeReviewInfrastructure {
  ...
  private readonly snapshots: JobEvaluationSnapshotCommands;

  constructor(
    database: Database,
    snapshots: JobEvaluationSnapshotCommands,
  ...
  private async ensureSnapshot(
    ...
    return this.snapshots.ensureCurrent(organizationId, jobDescriptionId);
  }
