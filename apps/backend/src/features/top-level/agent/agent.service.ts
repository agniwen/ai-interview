...
import { TOP_LEVEL_AGENT_JOBS_PORT } from "./agent.port.js";
import type { TopLevelAgentJobsPort, TopLevelAgentPort } from "./agent.port.js";
import type {
...
@Injectable()
export class AgentService implements TopLevelAgentPort {
  constructor(
