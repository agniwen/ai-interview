...
import { TOP_LEVEL_AGENT_JOBS_PORT } from "../agent/agent.port.js";
import type { TopLevelAgentJobsPort } from "../agent/agent.port.js";
...
@Injectable()
export class InterviewService implements TopLevelInterviewPort {
  constructor(
    @Inject(TOP_LEVEL_DATABASE_PORT)
    private readonly database: TopLevelDatabasePort,
    @Inject(TOP_LEVEL_AGENT_JOBS_PORT)
    private readonly jobs: TopLevelAgentJobsPort,
  ) {}
