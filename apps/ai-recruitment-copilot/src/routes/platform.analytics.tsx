...
import { platformAnalyticsSearchSchema } from "@/lib/start/server-fn-validators";
...
function AnalyticsDashboardPage({ dashboard }: { dashboard: PlatformAnalyticsSummary }) {
  return (
...
const loadPlatformAnalyticsState = createServerFn({ method: "GET" })
  .validator(platformAnalyticsSearchSchema)
