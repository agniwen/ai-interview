...
// 「发起 AI 面试」弹窗：在招聘台内确认候选人的异步生成题目并落库。
...
//
// "Launch AI interview" dialog. On open, use questions generated by the resume
// parsing worker, falling back to the workspace-scoped generation route for legacy
// records. Submitting calls launchInterviewFromResume
    ...
    <>
      ...
      >
        <Modal
          description={
            candidateName
              ? `确认 ${candidateName} 的面试题并发起 AI 面试`
              : "确认面试题并发起 AI 面试"
          }
          dismissible={!isBusy}
          headerExtra={
