        ...
        >
          <FieldGroup className="gap-5">
            ...
            <div className="grid gap-4 sm:grid-cols-[1fr_120px]">
              <Field>
                <FieldLabel htmlFor="platform-mail-ingest-host">IMAP 主机</FieldLabel>
                <Input
                  id="platform-mail-ingest-host"
                  disabled={pending}
                  onChange={(event) =>
              ...
              <Field>
                <FieldLabel htmlFor="platform-mail-ingest-port">端口</FieldLabel>
                <Input
                  id="platform-mail-ingest-port"
                  disabled={pending}
                  inputMode="numeric"
                  onChange={(event) =>
