...
const StudioPersonDetailDialog = lazy(async () => {
  const mod = await import("@/components/studio/studio-person-detail-dialog");
  return { default: mod.StudioPersonDetailDialog };
});

const LaunchInterviewDialog = lazy(async () => {
  const mod = await import("@/components/studio/resumes/launch-interview-dialog");
...
const StudioPersonEditDialog = lazy(async () => {
  const mod = await import("@/components/studio/studio-person-edit-dialog");
